...
object PreferKey {
    ...
    const val clickActionHTL = "clickActionHeaderLeft"
    const val clickActionHTC = "clickActionHeaderCenter"
    const val clickActionHTR = "clickActionHeaderRight"
    const val clickActionFTL = "clickActionFooterLeft"
    const val clickActionFTC = "clickActionFooterCenter"
    const val clickActionFTR = "clickActionFooterRight"
    ...
    const val readAloudResetParagraphAfterDict = "readAloudResetParagraphAfterDict"
